...
class ButtonComponent {
    ...
    private class RoundedBorder(private val color: Color, private val thickness: Int, private val radius: Int) : Border {
        override fun getBorderInsets(c: Component?): Insets = Insets(thickness + radius, thickness + radius, thickness + radius, thickness + radius)
