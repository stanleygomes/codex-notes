...
class NotesViewProvider {
    ...
    onImportNotes;
    onOpenLocation;
    static viewType = 'codexNotes.notesView';
    view;
    currentQuery = '';
    currentSort = SortTypeEnum_1.SortTypeEnum.DATE;
    filterFavorites = false;
    activeDateFilter;
    constructor(extensionUri, repository, searchService, sortService, filterService, onOpenNote, onCreateNote, onDeleteNote, onRenameNote, onDuplicateNote, onToggleFavorite, onChangeColor, onExportNotes, onImportNotes, onOpenLocation) {
        ...
        this.onRenameNote = onRenameNote;
        this.onDuplicateNote = onDuplicateNote;
        this.onToggleFavorite = onToggleFavorite;
        this.onChangeColor = onChangeColor;
        this.onExportNotes = onExportNotes;
        this.onImportNotes = onImportNotes;
    ...
    serializeNotes(notes) {
        return notes.map((note) => ({
            ...
            dateLabel: DateHelper_1.DateHelper.toHumanRelative(note.updatedAt),
            isFavorite: note.isFavorite,
            color: note.color,
            colorHex: NoteColorEnum_1.NOTE_COLOR_HEX[note.color],
        }));
    }
    getPreview(note) {
